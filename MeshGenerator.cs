...
public class MeshGenerator : MonoBehaviour
{
    ...
    public class Square
    {
        ...
        public Square(ControlNode _topLeft, ControlNode _topRight, ControlNode _bottomRight, ControlNode _bottomLeft)
        {
            ...
            if (topRight.active != 0)
            {
                configuration += 4;
            }
            if (bottomRight.active != 0)
            {
                configuration += 2;
            }
            if (bottomLeft.active != 0)
            {
                configuration += 1;
            }
        }
    ...
    public class ControlNode : Node
    {
        ...
        public ControlNode(Vector3 _pos, int _active, float squareSize) : base(_pos)
        {
            active = _active;
